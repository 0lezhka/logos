...
insert into book (title, description, publication_date, category, isbn, qty_pages, author_name, 
author_surname, author_email, author_age, author_birthdate, author_awards)
...
4211, 'Marcel', 'Proust', 'prust@gmail.com', 51, '1871-07-10', null),
...
husband with a good fortune.', '1813-09-10', 'love story', '9780141439518', 480, 'Jane', 'Austen', 'austen@gmail.com',
41, '1775-12-16', null),
...
literature.', '1967-02-02', 'opus', '0060883286', 417, 'Gabriel', 'García Márquez', 'marquez@gmail.com', 87, '1927-03-06',
...
560, 'Fyodor', 'Dostoevsky', 'dostoevsky@gmail.com', 59, '1881-02-09', null),
...
life-changing experience.', '1904-06-16', 'novel', '9781857151008', 1144, 'James', 'Joyce', 'joyce@gmail.com', 58, '1882-02-02',
...
'9780064404990', 208, 'Clive Staples', 'Lewis', 'lewis@gmail.com', 64, '1898-11-29', '2006 - Hugo Awards'),
...
528, 'Mikhail', 'Bulgakov', 'bulgakov@gmail.com', 48, '1891-05-15', null),
...
'9780241980347', 544, 'John', 'Steinbeck', 'steinback@gmail.com', 66, '1902-02-27', '1945 - Academy Awards, USA; 1962 - Nobel Prize'),
...
slavery, abuse and corruption.', '1884-10-15', 'adventure', '9780141199009', 336, 'Mark', 'Twain', 'twain@gmail.com', 74, '1835-11-30', null),
...
'psychology thriller', '0451163966', 272, 'Ken', 'Kesey', 'kesey@gmail.com', 66, '1935-09-17', null);

select * from book;
select * from book where id = 5 or id = 10 or id = 13;
select * from book where qty_pages > 150;
select * from book where author_age > 30;
select * from book where author_awards is null;
select * from book where author_email = 'kesey@gmail.com';
select * from book where isbn = '9780064404990';
select * from book where category = 'novel';
select * from book where qty_pages > 200 and author_age > 25;
select * from book where category = 'adventure' or category = 'fantasy';
select * from book order by title;
select * from book order by author_email;
select * from book order by qty_pages desc;
